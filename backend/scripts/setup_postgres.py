...
def check_postgres_running():
    ...
    result = run_command("pg_isready -h localhost -p 5432", check=False, capture_output=True)
    if result:
        ...
        print("  Docker: docker run -d --name postgres -p 5432:5432 -e POSTGRES_PASSWORD=postgres postgres")
        return False
