...
def fetch_commodity_from_yfinance(
    symbol: str, start_date: str, end_date: str, interval: str = "1d"
) -> pd.DataFrame:
    """
    Fetches commodity data from yfinance and formats it.
    """
    logger.info(
        f"Fetching yfinance data for commodity symbol: {symbol}, interval: {interval}, start: {start_date}, end: {end_date}"
    )
