...
@patch("app.services.a_industries_fetcher.ak.stock_board_industry_spot_em")
@patch("app.services.a_industries_fetcher.ak.stock_board_industry_hist_em")
@patch("app.services.a_industries_fetcher.ak.stock_board_industry_name_em")
...
@patch("app.services.a_industries_fetcher.ak.stock_board_industry_index_ths")
@patch("app.services.a_industries_fetcher.ak.stock_board_industry_hist_em")
