...
@patch("app.data.fetchers.stock_fetchers.a_share_fetcher.ak.stock_bj_a_spot_em")
...
@patch("app.data.fetchers.stock_fetchers.us_stock_fetcher.fetch_from_yfinance")
