...
from app.data.fetchers.stock_fetchers.a_share_fetcher import (
    _baostock_query_with_retry,
    baostock_session,
    fetch_annual_net_profit_from_baostock,
    update_stock_list_from_akshare,
)
...
class TestBaostockSession:
    ...
    @patch("app.data.fetchers.stock_fetchers.a_share_fetcher.bs.login")
    @patch("app.data.fetchers.stock_fetchers.a_share_fetcher.bs.logout")
...
class TestBaostockQueryWithRetry:
    ...
    def test_baostock_query_circuit_breaker(self):
        ...
        with patch("app.data.fetchers.stock_fetchers.a_share_fetcher.time.sleep"):
            result = _baostock_query_with_retry(mock_query_func, "test_code")
...
class TestFetchAnnualNetProfit:
    ...
    @patch("app.data.fetchers.stock_fetchers.a_share_fetcher.baostock_session")
    @patch(
        "app.data.fetchers.stock_fetchers.a_share_fetcher._baostock_query_with_retry"
    )
...
class TestUpdateStockListFromAkshare:
    ...
    @patch("app.data.fetchers.stock_fetchers.a_share_fetcher.ak.stock_sh_a_spot_em")
    @patch("app.data.fetchers.stock_fetchers.a_share_fetcher.ak.stock_sz_a_spot_em")
    @patch("app.data.fetchers.stock_fetchers.a_share_fetcher.ak.fund_etf_spot_em")
    @patch("app.data.fetchers.stock_fetchers.a_share_fetcher.sqlite_insert")
