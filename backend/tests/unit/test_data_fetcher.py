...
from app.data.managers.data_manager import force_update_stock_list, get_all_stocks_list
...
class TestGetAllStocksList:
    ...
    def test_get_all_stocks_list_a_share_empty_cache(self):
        ...
        with patch(
            "app.data.managers.data_manager.a_share_fetcher.update_stock_list_from_akshare"
        ) as mock_update:
    ...
    def test_get_all_stocks_list_us_stock_empty_cache(self):
        ...
        with patch(
            "app.data.managers.data_manager.us_stock_fetcher.update_us_stock_list"
        ) as mock_update:
