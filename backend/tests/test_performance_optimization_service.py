...
from app.services.data_deduplication_service import DeduplicationReport
from app.services.data_validation_service import ValidationReport
from app.services.performance_optimization_service import (
    CacheManager, MemoryManager, PerformanceConfig, PerformanceMetrics,
    PerformanceOptimizationService, ProcessingMode, performance_monitor)
...
class TestCacheManager(unittest.TestCase):
    ...
    def test_cache_operations(self):
        ...
        # 获取不存在的键
        value_none = self.cache_manager.get("nonexistent")
...
class TestPerformanceOptimizationService(unittest.TestCase):
    ...
    @patch("app.services.performance_optimization_service.DataValidationService")
    ...
    @patch("app.services.performance_optimization_service.DataValidationService")
    @patch("app.services.performance_optimization_service.sessionmaker")
    ...
    @patch("app.services.performance_optimization_service.DataDeduplicationService")
    ...
    def test_cache_management_integration(self):
        """测试缓存管理集成"""
        # 测试缓存操作
        self.perf_service.cache_manager.set("test_key", "test_value")
        value = self.perf_service.cache_manager.get("test_key")
